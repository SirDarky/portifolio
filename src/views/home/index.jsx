      ...
      <div id="home" className="continerInfo">
        <div className="containerHomeContent">
          <div className="containerTitle">
            <div className="firstChildText text">EXPERIÊNCIA EM <p className="text-[#b24cff]">DESENVOLVIMENTO</p></div>
            <div className="secondChildText text">
              E <p className="text-[#ff4dca]">RAPIDEZ</p><div className="text-[#f5f5f5]"> PARA EMPRESAS.</div>
            </div>
          </div>
